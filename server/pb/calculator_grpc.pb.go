...
type CalculatorClient interface {
	Add(ctx context.Context, in *CalcutorRequest, opts ...grpc.CallOption) (*CalcutorResponse, error)
	Subtract(ctx context.Context, in *CalcutorRequest, opts ...grpc.CallOption) (*CalcutorResponse, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *CalcutorRequest, opts ...grpc.CallOption) (*CalcutorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CalcutorResponse)
...
func (c *calculatorClient) Subtract(ctx context.Context, in *CalcutorRequest, opts ...grpc.CallOption) (*CalcutorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CalcutorResponse)
...
type CalculatorServer interface {
	Add(context.Context, *CalcutorRequest) (*CalcutorResponse, error)
	Subtract(context.Context, *CalcutorRequest) (*CalcutorResponse, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *CalcutorRequest) (*CalcutorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedCalculatorServer) Subtract(context.Context, *CalcutorRequest) (*CalcutorResponse, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*CalcutorRequest))
	}
...
func _Calculator_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Subtract(ctx, req.(*CalcutorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
